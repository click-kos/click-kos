...
import { getAuthStatus, getUserData, clearAuth, type UserData } from "../lib/auth";

// Type definitions
type TabId = "overview" | "orders" | "menu" | "analytics" | "dashboard" | "admin";
    ...
    <div>
      <div className="flex flex-row items-center justify-between px-4 py-3">
        ...
        <div className="flex items-center">
          <Link href="/" className="text-lg font-bold text-[#0E2148] dark:text-white">
            Click & Kos
          </Link>
        </div>
